...
2. **What Antigravity executes automatically:**
   ...
   - **For Every Email Address**: Creates a distinct, personalized email with:
     ...
     - Active Vercel demo link (`https://coldemail-dun.vercel.app/coldemail/[CompanyNameWithoutSpaces]/index.html`).
...
| **6. Exact Vercel URL Format** | Must strictly follow: `https://coldemail-dun.vercel.app/coldemail/[CompanyNameWithoutSpaces]/index.html`. |
